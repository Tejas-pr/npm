...
7. authorization checks—verify every protected endpoint enforces permission checks server-side (don't rely on frontend restrictions) and test for IDOR (Insecure Direct Object Reference) vulnerabilities.